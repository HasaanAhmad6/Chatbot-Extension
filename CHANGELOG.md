...
- **Workspace Customizations**: Updated `.agents/AGENTS.md` to require graphify updates after codebase changes and enforce querying graphify first for codebase/architecture questions.
